    ...
    <main id="main">
      ...
      <article>
        <h2>Tag der offenen Tür</h2>
          ...
          <img class="img" src="img/index/offenetuer.jpg" alt="Bild von einem lächelnden Mann mit Hund vor dem offenen Eingang">

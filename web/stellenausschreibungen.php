    ...
    <main id="main">
      ...
      <div class="flex">
        ...
        <p>Das Tierheim Pfotenfreunde Trier sucht qualifizierte Tierpflegerinnen und Tierpfleger für unsere Hundeabteilung. 
          Wenn Sie eine Leidenschaft für Hunde haben, über Erfahrung in der Tierpflege verfügen und die Herausforderungen in einem tierlieben Team annehmen möchten, dann könnte diese Position die perfekte Gelegenheit für Sie sein.
        </p>
        <h3>Aufgaben:</h3>
        <ul>
        ...
        <h3>Bewerbungsfrist: [12.3.2024]</h3>
        </article>
        <form action="../lib/bewerbungVerarbeitung.php" method="post" autocomplete="on">
          ...
          <input type="tel" id="Telefonnummer" name="Telefonnummer" pattern="[0-9]{9,14}" placeholder="0123456789"><br>
          <small>Bitte geben Sie eine gültige Telefonnummer ein (mindestens 9 Ziffern).</small><br>
          
          <label for="Handynummer">Handynummer:</label><br>
          <input type="tel" id="Handynummer" name="Handynummer" pattern="\+[0-9]{1,4}[0-9]{9,13}" placeholder="+491234567890"><br>
      ...
      <div class="flex">
        ...
        <li>Mitwirkung bei der Vermittlung von Katzen in ein liebevolles Zuhause<br></li>
        </ul>
        <h3>Anforderungen:</h3>
        <ul>
        ...
        <form action="../lib/bewerbungVerarbeitung.php" method="post" autocomplete="on">
          ...
          <input type="text" id="Vorname1" name="Vorname" required placeholder="Vorname"><br>
    
          <label for="Nachname1">Nachname:</label><br>
          <input type="text" id="Nachname1" name="Nachname" required placeholder="Nachname"><br>
    
          <label for="email1">E-Mail:</label><br>
          <input type="email" id="email1" name="email" required placeholder="beispiel@email.de"><br>
    
          <label for="Telefonnummer1">Telefonnummer:</label><br>
          <input type="tel" id="Telefonnummer1" name="Telefonnummer" pattern="[0-9]{9,14}"     placeholder="0123456789"><br>
          <small>Bitte geben Sie eine gültige Telefonnummer ein (mindestens 9 Ziffern).</small><br>
          <label for="Handynummer1">Handynummer:</label><br>
          <input type="tel" id="Handynummer1" name="Handynummer" pattern="\+[0-9]{1,4}[0-9]{9,13}" placeholder="+491234567890"><br>
          <small>Bitte geben Sie eine gültige Handynummer ein (beginnend mit '+' gefolgt von Landesvorwahl und Nummer).</small><br>
    
          <label for="Erfahrung1">Berufserfahrung (Jahre):</label><br>
          <input type="number" id="Erfahrung1" name="Erfahrung" required><br>
    
          <label for="Nachricht1">Nachricht:</label><br>
          <textarea id="Nachricht1" name="Nachricht" rows="4"></textarea><br>
    
          <label for="Lebenslauf1">Lebenslauf</label><br>
          <input type="file" id="Lebenslauf1" name="Lebenslauf" required><br>
          
          <label for="Anschreiben1">Anschreiben</label><br>
          <input type="file" id="Anschreiben1" name="Anschreiben" required><br>
          
          <label for="Qualifikationen1">Qualifikationen</label><br>
          <input type="file" id="Qualifikationen1" name="Qualifikationen"><br>
      ...
      <div class="flex">
        ...
        <p>
          Das Tierheim Pfotenfreunde Trier sucht einen engagierten Kundenbetreuer zur Unterstützung unseres Teams. 
          Als Kundenbetreuer sind Sie die Schnittstelle zwischen dem Tierheim und potenziellen Tiereltern. 
          Wenn Sie Freude am Umgang mit Menschen und Tieren haben, kommunikativ sind und eine positive Einstellung mitbringen, möchten wir Sie gerne kennenlernen.
        </p>
        <h3>Aufgaben:</h3>
        <ul>
        ...
        <form action="../lib/bewerbungVerarbeitung.php" method="post" autocomplete="on">
          ...
          <input type="text" id="Vorname2" name="Vorname" required placeholder="Vorname"><br>
    
          <label for="Nachname2">Nachname:</label><br>
          <input type="text" id="Nachname2" name="Nachname" required placeholder="Nachname"><br>
    
          <label for="email2">E-Mail:</label><br>
          <input type="email" id="email2" name="email" required placeholder="beispiel@email.de"><br>
    
          <label for="Telefonnummer2">Telefonnummer:</label><br>
          <input type="tel" id="Telefonnummer2" name="Telefonnummer" pattern="[0-9]{9,14}" placeholder="0123456789"><br>
          <small>Bitte geben Sie eine gültige Telefonnummer ein (mindestens 9 Ziffern).</small><br>
          <label for="Handynummer2">Handynummer:</label><br>
          <input type="tel" id="Handynummer2" name="Handynummer" pattern="\+[0-9]{1,4}[0-9]{9,13}" placeholder="+491234567890"><br>
          <small>Bitte geben Sie eine gültige Handynummer ein (beginnend mit '+' gefolgt von Landesvorwahl und Nummer).</small><br>
    
          <label for="Erfahrung2">Berufserfahrung (Jahre):</label><br>
          <input type="number" id="Erfahrung2" name="Erfahrung" required><br>
    
          <label for="Nachricht2">Nachricht:</label><br>
          <textarea id="Nachricht2" name="Nachricht" rows="4"></textarea><br>
    
          <label for="Lebenslauf2">Lebenslauf</label><br>
          <input type="file" id="Lebenslauf2" name="Lebenslauf" required><br>
    
          <label for="Anschreiben2">Anschreiben</label><br>
          <input type="file" id="Anschreiben2" name="Anschreiben" required><br>
    
          <label for="Qualifikationen2">Qualifikationen</label><br>
          <input type="file" id="Qualifikationen2" name="Qualifikationen"><br>
      ...
      <h2>Initiativbewerbung und Ehrenamtliche Aushilfe</h2>
        <p>
          Falls Sie Interesse an einer anderen Art von Anstellung, Ausbildung oder einer ehrenamtlichen Mitarbeit im Tierheim Pfotenfreunde Trier haben, freuen wir uns über Ihre Bewerbung!
